...
namespace LPS.Util
{
	public class SerializeCommand : CommandBase
	{
		...
		public override object Execute (LPS.ToolScript.Context context, System.IO.TextWriter Out, System.IO.TextWriter Info, System.IO.TextWriter Err, object[] Params)
		{
			object o = Params[0];
