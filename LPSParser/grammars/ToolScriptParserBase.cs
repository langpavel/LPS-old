...
namespace LPS.ToolScript
{
    ...
    public enum Symbols : int
    {
        ...
        /// <summary>
        /// <para>Symbol: hpaned</para>
        /// <para><c>hpaned</c></para>
        /// </summary>
        Hpaned = 76,
        ...
        /// <summary>
        /// <para>Symbol: liststore</para>
        /// <para><c>liststore</c></para>
        /// </summary>
        Liststore = 88,
        ...
        /// <summary>
        /// <para>Symbol: scrolled</para>
        /// <para><c>scrolled</c></para>
        /// </summary>
        Scrolled = 103,
        ...
        /// <summary>
        /// <para>Symbol: treestore</para>
        /// <para><c>treestore</c></para>
        /// </summary>
        Treestore = 119,

        /// <summary>
        /// <para>Symbol: treeview</para>
        /// <para><c>treeview</c></para>
        /// </summary>
        Treeview = 120,
        ...
        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Column Name&gt; ::= ID</c></para>
        /// </summary>
        RuleColumnnameId = ToolScriptParserBase.RulesOffset + 53,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Column Name&gt; ::= StringLiteral</c></para>
        /// </summary>
        RuleColumnnameStringliteral = ToolScriptParserBase.RulesOffset + 54,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Column List&gt; ::= &lt;Column List&gt; ',' &lt;Column Name&gt;</c></para>
        /// </summary>
        RuleColumnlistComma = ToolScriptParserBase.RulesOffset + 55,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Column List&gt; ::= &lt;Column Name&gt;</c></para>
        /// </summary>
        RuleColumnlist = ToolScriptParserBase.RulesOffset + 56,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Column List&gt; ::= </c></para>
        /// </summary>
        RuleColumnlist2 = ToolScriptParserBase.RulesOffset + 57,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Database&gt; ::= database ID '{' &lt;DB Tables&gt; '}'</c></para>
        /// </summary>
        RuleDatabaseDatabaseIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 58,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Database&gt; ::= extends database ID '{' &lt;DB Tables&gt; '}'</c></para>
        /// </summary>
        RuleDatabaseExtendsDatabaseIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 59,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Tables&gt; ::= &lt;DB Tables&gt; &lt;DB Table&gt;</c></para>
        /// </summary>
        RuleDbtables = ToolScriptParserBase.RulesOffset + 60,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Tables&gt; ::= </c></para>
        /// </summary>
        RuleDbtables2 = ToolScriptParserBase.RulesOffset + 61,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table&gt; ::= template table ID '{' &lt;DB Columns&gt; '}' &lt;DB Table Attr List&gt;</c></para>
        /// </summary>
        RuleDbtableTemplateTableIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 62,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table&gt; ::= template table ID template ID '{' &lt;DB Columns&gt; '}' &lt;DB Table Attr List&gt;</c></para>
        /// </summary>
        RuleDbtableTemplateTableIdTemplateIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 63,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table&gt; ::= table ID '{' &lt;DB Columns&gt; '}' &lt;DB Table Attr List&gt;</c></para>
        /// </summary>
        RuleDbtableTableIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 64,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table&gt; ::= table ID template ID '{' &lt;DB Columns&gt; '}' &lt;DB Table Attr List&gt;</c></para>
        /// </summary>
        RuleDbtableTableIdTemplateIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 65,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table&gt; ::= extends table ID '{' &lt;DB Columns&gt; '}' &lt;DB Table Attr List&gt;</c></para>
        /// </summary>
        RuleDbtableExtendsTableIdLbraceRbrace = ToolScriptParserBase.RulesOffset + 66,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Columns&gt; ::= &lt;DB Columns&gt; &lt;DB Column&gt;</c></para>
        /// </summary>
        RuleDbcolumns = ToolScriptParserBase.RulesOffset + 67,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Columns&gt; ::= </c></para>
        /// </summary>
        RuleDbcolumns2 = ToolScriptParserBase.RulesOffset + 68,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column&gt; ::= &lt;Column Name&gt; &lt;DB Column Type&gt; &lt;DB Column Attr List&gt; ';'</c></para>
        /// </summary>
        RuleDbcolumnSemi = ToolScriptParserBase.RulesOffset + 69,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= primary</c></para>
        /// </summary>
        RuleDbcolumntypePrimary = ToolScriptParserBase.RulesOffset + 70,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= foreign ID</c></para>
        /// </summary>
        RuleDbcolumntypeForeignId = ToolScriptParserBase.RulesOffset + 71,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= foreign ID '(' ID ')'</c></para>
        /// </summary>
        RuleDbcolumntypeForeignIdLparanIdRparan = ToolScriptParserBase.RulesOffset + 72,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= many ID</c></para>
        /// </summary>
        RuleDbcolumntypeManyId = ToolScriptParserBase.RulesOffset + 73,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= many ID through ID</c></para>
        /// </summary>
        RuleDbcolumntypeManyIdThroughId = ToolScriptParserBase.RulesOffset + 74,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= many ID through ID '(' ID ',' ID ')'</c></para>
        /// </summary>
        RuleDbcolumntypeManyIdThroughIdLparanIdCommaIdRparan = ToolScriptParserBase.RulesOffset + 75,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= varchar</c></para>
        /// </summary>
        RuleDbcolumntypeVarchar = ToolScriptParserBase.RulesOffset + 76,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= varchar '(' IntLiteral ')'</c></para>
        /// </summary>
        RuleDbcolumntypeVarcharLparanIntliteralRparan = ToolScriptParserBase.RulesOffset + 77,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= integer</c></para>
        /// </summary>
        RuleDbcolumntypeInteger = ToolScriptParserBase.RulesOffset + 78,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= bool</c></para>
        /// </summary>
        RuleDbcolumntypeBool = ToolScriptParserBase.RulesOffset + 79,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= decimal '(' IntLiteral ',' IntLiteral ')'</c></para>
        /// </summary>
        RuleDbcolumntypeDecimalLparanIntliteralCommaIntliteralRparan = ToolScriptParserBase.RulesOffset + 80,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= date</c></para>
        /// </summary>
        RuleDbcolumntypeDate = ToolScriptParserBase.RulesOffset + 81,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= time</c></para>
        /// </summary>
        RuleDbcolumntypeTime = ToolScriptParserBase.RulesOffset + 82,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= datetime</c></para>
        /// </summary>
        RuleDbcolumntypeDatetime = ToolScriptParserBase.RulesOffset + 83,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= daterange</c></para>
        /// </summary>
        RuleDbcolumntypeDaterange = ToolScriptParserBase.RulesOffset + 84,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= timerange</c></para>
        /// </summary>
        RuleDbcolumntypeTimerange = ToolScriptParserBase.RulesOffset + 85,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Type&gt; ::= datetimerange</c></para>
        /// </summary>
        RuleDbcolumntypeDatetimerange = ToolScriptParserBase.RulesOffset + 86,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr List&gt; ::= &lt;DB Column Attr List&gt; &lt;DB Column Attr&gt;</c></para>
        /// </summary>
        RuleDbcolumnattrlist = ToolScriptParserBase.RulesOffset + 87,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr List&gt; ::= </c></para>
        /// </summary>
        RuleDbcolumnattrlist2 = ToolScriptParserBase.RulesOffset + 88,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr&gt; ::= unique</c></para>
        /// </summary>
        RuleDbcolumnattrUnique = ToolScriptParserBase.RulesOffset + 89,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr&gt; ::= not null</c></para>
        /// </summary>
        RuleDbcolumnattrNotNull = ToolScriptParserBase.RulesOffset + 90,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr&gt; ::= index</c></para>
        /// </summary>
        RuleDbcolumnattrIndex = ToolScriptParserBase.RulesOffset + 91,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr&gt; ::= default &lt;Value&gt;</c></para>
        /// </summary>
        RuleDbcolumnattrDefault = ToolScriptParserBase.RulesOffset + 92,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Column Attr&gt; ::= ID '=' &lt;Value&gt;</c></para>
        /// </summary>
        RuleDbcolumnattrIdEq = ToolScriptParserBase.RulesOffset + 93,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr List&gt; ::= &lt;DB Table Attr List&gt; &lt;DB Table Attr&gt;</c></para>
        /// </summary>
        RuleDbtableattrlist = ToolScriptParserBase.RulesOffset + 94,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr List&gt; ::= </c></para>
        /// </summary>
        RuleDbtableattrlist2 = ToolScriptParserBase.RulesOffset + 95,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr&gt; ::= index '(' &lt;Column List&gt; ')' ';'</c></para>
        /// </summary>
        RuleDbtableattrIndexLparanRparanSemi = ToolScriptParserBase.RulesOffset + 96,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr&gt; ::= unique '(' &lt;Column List&gt; ')' ';'</c></para>
        /// </summary>
        RuleDbtableattrUniqueLparanRparanSemi = ToolScriptParserBase.RulesOffset + 97,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr&gt; ::= &lt;DB Trigger Runs&gt; position &lt;NumLiteral&gt; &lt;Stm&gt;</c></para>
        /// </summary>
        RuleDbtableattrPosition = ToolScriptParserBase.RulesOffset + 98,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Table Attr&gt; ::= ID '=' &lt;Value&gt; ';'</c></para>
        /// </summary>
        RuleDbtableattrIdEqSemi = ToolScriptParserBase.RulesOffset + 99,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Runs&gt; ::= &lt;DB Trigger Runs&gt; ',' &lt;DB Trigger Run&gt;</c></para>
        /// </summary>
        RuleDbtriggerrunsComma = ToolScriptParserBase.RulesOffset + 100,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Runs&gt; ::= &lt;DB Trigger Run&gt;</c></para>
        /// </summary>
        RuleDbtriggerruns = ToolScriptParserBase.RulesOffset + 101,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= before select</c></para>
        /// </summary>
        RuleDbtriggerrunBeforeSelect = ToolScriptParserBase.RulesOffset + 102,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= after select</c></para>
        /// </summary>
        RuleDbtriggerrunAfterSelect = ToolScriptParserBase.RulesOffset + 103,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= before insert</c></para>
        /// </summary>
        RuleDbtriggerrunBeforeInsert = ToolScriptParserBase.RulesOffset + 104,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= after insert</c></para>
        /// </summary>
        RuleDbtriggerrunAfterInsert = ToolScriptParserBase.RulesOffset + 105,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= before update</c></para>
        /// </summary>
        RuleDbtriggerrunBeforeUpdate = ToolScriptParserBase.RulesOffset + 106,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= after update</c></para>
        /// </summary>
        RuleDbtriggerrunAfterUpdate = ToolScriptParserBase.RulesOffset + 107,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= before delete</c></para>
        /// </summary>
        RuleDbtriggerrunBeforeDelete = ToolScriptParserBase.RulesOffset + 108,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= after delete</c></para>
        /// </summary>
        RuleDbtriggerrunAfterDelete = ToolScriptParserBase.RulesOffset + 109,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= before modified</c></para>
        /// </summary>
        RuleDbtriggerrunBeforeModified = ToolScriptParserBase.RulesOffset + 110,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;DB Trigger Run&gt; ::= after modified</c></para>
        /// </summary>
        RuleDbtriggerrunAfterModified = ToolScriptParserBase.RulesOffset + 111,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;NumLiteral&gt; ::= IntLiteral</c></para>
        /// </summary>
        RuleNumliteralIntliteral = ToolScriptParserBase.RulesOffset + 112,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;NumLiteral&gt; ::= DecimalLiteral</c></para>
        /// </summary>
        RuleNumliteralDecimalliteral = ToolScriptParserBase.RulesOffset + 113,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Function&gt; ::= function ID '(' &lt;Func args&gt; ')' &lt;Stm&gt;</c></para>
        /// </summary>
        RuleFunctionFunctionIdLparanRparan = ToolScriptParserBase.RulesOffset + 114,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Function&gt; ::= function '(' &lt;Func args&gt; ')' &lt;Stm&gt;</c></para>
        /// </summary>
        RuleFunctionFunctionLparanRparan = ToolScriptParserBase.RulesOffset + 115,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Widget&gt; ::= window ID &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleWidgetWindowId = ToolScriptParserBase.RulesOffset + 116,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Widget&gt; ::= window &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleWidgetWindow = ToolScriptParserBase.RulesOffset + 117,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Widget&gt; ::= widget ID &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleWidgetWidgetId = ToolScriptParserBase.RulesOffset + 118,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Widget&gt; ::= widget &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleWidgetWidget = ToolScriptParserBase.RulesOffset + 119,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;WndParam List&gt; ::= &lt;WndParam&gt; &lt;WndParam List&gt;</c></para>
        /// </summary>
        RuleWndparamlist = ToolScriptParserBase.RulesOffset + 120,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;WndParam List&gt; ::= </c></para>
        /// </summary>
        RuleWndparamlist2 = ToolScriptParserBase.RulesOffset + 121,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;WndParam&gt; ::= ID '=' &lt;Expr&gt; ';'</c></para>
        /// </summary>
        RuleWndparamIdEqSemi = ToolScriptParserBase.RulesOffset + 122,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;WndParam&gt; ::= ID ';'</c></para>
        /// </summary>
        RuleWndparamIdSemi = ToolScriptParserBase.RulesOffset + 123,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout List&gt; ::= &lt;Layout List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleLayoutlist = ToolScriptParserBase.RulesOffset + 124,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout List&gt; ::= </c></para>
        /// </summary>
        RuleLayoutlist2 = ToolScriptParserBase.RulesOffset + 125,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= hbox &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockHboxEnd = ToolScriptParserBase.RulesOffset + 126,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= vbox &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockVboxEnd = ToolScriptParserBase.RulesOffset + 127,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= hbuttonbox &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockHbuttonboxEnd = ToolScriptParserBase.RulesOffset + 128,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= vbuttonbox &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockVbuttonboxEnd = ToolScriptParserBase.RulesOffset + 129,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= hpaned &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockHpanedEnd = ToolScriptParserBase.RulesOffset + 130,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= vpaned &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockVpanedEnd = ToolScriptParserBase.RulesOffset + 131,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= table &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockTableEnd = ToolScriptParserBase.RulesOffset + 132,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= toolbar &lt;WndParam List&gt; &lt;Layout List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockToolbarEnd = ToolScriptParserBase.RulesOffset + 133,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= button &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleLayoutblockButton = ToolScriptParserBase.RulesOffset + 134,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= button &lt;WndParam List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockButtonEnd = ToolScriptParserBase.RulesOffset + 135,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= toolbutton &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleLayoutblockToolbutton = ToolScriptParserBase.RulesOffset + 136,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= toolbutton &lt;WndParam List&gt; end</c></para>
        /// </summary>
        RuleLayoutblockToolbuttonEnd = ToolScriptParserBase.RulesOffset + 137,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= scrolled &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleLayoutblockScrolled = ToolScriptParserBase.RulesOffset + 138,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= align &lt;WndParam List&gt; &lt;Layout Block&gt;</c></para>
        /// </summary>
        RuleLayoutblockAlign = ToolScriptParserBase.RulesOffset + 139,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= image &lt;WndParam List&gt;</c></para>
        /// </summary>
        RuleLayoutblockImage = ToolScriptParserBase.RulesOffset + 140,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= treeview &lt;WndParam List&gt; &lt;TreeView Columns&gt; end</c></para>
        /// </summary>
        RuleLayoutblockTreeviewEnd = ToolScriptParserBase.RulesOffset + 141,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= StringLiteral &lt;WndParam List&gt;</c></para>
        /// </summary>
        RuleLayoutblockStringliteral = ToolScriptParserBase.RulesOffset + 142,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= &lt;Menu Block&gt;</c></para>
        /// </summary>
        RuleLayoutblock = ToolScriptParserBase.RulesOffset + 143,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Layout Block&gt; ::= '[' &lt;Expr&gt; ']' &lt;WndParam List&gt;</c></para>
        /// </summary>
        RuleLayoutblockLbracketRbracket = ToolScriptParserBase.RulesOffset + 144,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Menu Block&gt; ::= menu &lt;WndParam List&gt; &lt;MenuItems List&gt; end</c></para>
        /// </summary>
        RuleMenublockMenuEnd = ToolScriptParserBase.RulesOffset + 145,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;MenuItems List&gt; ::= &lt;MenuItems List&gt; &lt;Menu Item&gt;</c></para>
        /// </summary>
        RuleMenuitemslist = ToolScriptParserBase.RulesOffset + 146,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;MenuItems List&gt; ::= </c></para>
        /// </summary>
        RuleMenuitemslist2 = ToolScriptParserBase.RulesOffset + 147,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Menu Item&gt; ::= &lt;Menu Block&gt;</c></para>
        /// </summary>
        RuleMenuitem = ToolScriptParserBase.RulesOffset + 148,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Menu Item&gt; ::= menuitem &lt;WndParam List&gt;</c></para>
        /// </summary>
        RuleMenuitemMenuitem = ToolScriptParserBase.RulesOffset + 149,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Menu Item&gt; ::= Separator</c></para>
        /// </summary>
        RuleMenuitemSeparator = ToolScriptParserBase.RulesOffset + 150,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;TreeView Columns&gt; ::= &lt;TreeView Columns&gt; &lt;TreeView Column&gt;</c></para>
        /// </summary>
        RuleTreeviewcolumns = ToolScriptParserBase.RulesOffset + 151,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;TreeView Columns&gt; ::= </c></para>
        /// </summary>
        RuleTreeviewcolumns2 = ToolScriptParserBase.RulesOffset + 152,
        ...
        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Store Items&gt; ::= &lt;Store Items&gt; &lt;Store Item&gt;</c></para>
        /// </summary>
        RuleStoreitems = ToolScriptParserBase.RulesOffset + 154,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Store Items&gt; ::= </c></para>
        /// </summary>
        RuleStoreitems2 = ToolScriptParserBase.RulesOffset + 155,
        ...
        /// </summary>
        RuleExprlistComma = ToolScriptParserBase.RulesOffset + 157,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr List&gt; ::= &lt;Expr&gt;</c></para>
        /// </summary>
        RuleExprlist = ToolScriptParserBase.RulesOffset + 158,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Dict List&gt; ::= &lt;Expr&gt; ':' &lt;Expr&gt; ',' &lt;Dict List&gt;</c></para>
        /// </summary>
        RuleDictlistColonComma = ToolScriptParserBase.RulesOffset + 159,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Dict List&gt; ::= &lt;Expr&gt; ':' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleDictlistColon = ToolScriptParserBase.RulesOffset + 160,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Dict List&gt; ::= </c></para>
        /// </summary>
        RuleDictlist = ToolScriptParserBase.RulesOffset + 161,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr&gt; ::= &lt;Widget&gt;</c></para>
        /// </summary>
        RuleExpr = ToolScriptParserBase.RulesOffset + 162,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr&gt; ::= &lt;Database&gt;</c></para>
        /// </summary>
        RuleExpr2 = ToolScriptParserBase.RulesOffset + 163,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr&gt; ::= liststore &lt;WndParam List&gt; &lt;Store Items&gt; end</c></para>
        /// </summary>
        RuleExprListstoreEnd = ToolScriptParserBase.RulesOffset + 164,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr&gt; ::= treestore &lt;WndParam List&gt; &lt;Store Items&gt; end</c></para>
        /// </summary>
        RuleExprTreestoreEnd = ToolScriptParserBase.RulesOffset + 165,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Expr&gt; ::= &lt;Op Assign&gt;</c></para>
        /// </summary>
        RuleExpr3 = ToolScriptParserBase.RulesOffset + 166,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '=' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignEq = ToolScriptParserBase.RulesOffset + 167,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '+=' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignPluseq = ToolScriptParserBase.RulesOffset + 168,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '-=' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignMinuseq = ToolScriptParserBase.RulesOffset + 169,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '*=' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignTimeseq = ToolScriptParserBase.RulesOffset + 170,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '/=' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignDiveq = ToolScriptParserBase.RulesOffset + 171,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '&lt;==' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignLteqeq = ToolScriptParserBase.RulesOffset + 172,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt; '&lt;==&gt;' &lt;Expr&gt;</c></para>
        /// </summary>
        RuleOpassignLteqeqgt = ToolScriptParserBase.RulesOffset + 173,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Assign&gt; ::= &lt;Op If&gt;</c></para>
        /// </summary>
        RuleOpassign = ToolScriptParserBase.RulesOffset + 174,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op If&gt; ::= &lt;Op Or&gt; '?' &lt;Op If&gt; ':' &lt;Op If&gt;</c></para>
        /// </summary>
        RuleOpifQuestionColon = ToolScriptParserBase.RulesOffset + 175,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op If&gt; ::= &lt;Op Or&gt;</c></para>
        /// </summary>
        RuleOpif = ToolScriptParserBase.RulesOffset + 176,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Or&gt; ::= &lt;Op Or&gt; or &lt;Op And&gt;</c></para>
        /// </summary>
        RuleOporOr = ToolScriptParserBase.RulesOffset + 177,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Or&gt; ::= &lt;Op And&gt;</c></para>
        /// </summary>
        RuleOpor = ToolScriptParserBase.RulesOffset + 178,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op And&gt; ::= &lt;Op And&gt; and &lt;Op Equate&gt;</c></para>
        /// </summary>
        RuleOpandAnd = ToolScriptParserBase.RulesOffset + 179,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op And&gt; ::= &lt;Op Equate&gt;</c></para>
        /// </summary>
        RuleOpand = ToolScriptParserBase.RulesOffset + 180,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Equate&gt; ::= &lt;Op Equate&gt; '==' &lt;Op Compare&gt;</c></para>
        /// </summary>
        RuleOpequateEqeq = ToolScriptParserBase.RulesOffset + 181,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Equate&gt; ::= &lt;Op Equate&gt; '!=' &lt;Op Compare&gt;</c></para>
        /// </summary>
        RuleOpequateExclameq = ToolScriptParserBase.RulesOffset + 182,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Equate&gt; ::= &lt;Op Equate&gt; in &lt;Op Compare&gt;</c></para>
        /// </summary>
        RuleOpequateIn = ToolScriptParserBase.RulesOffset + 183,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Equate&gt; ::= &lt;Op Compare&gt;</c></para>
        /// </summary>
        RuleOpequate = ToolScriptParserBase.RulesOffset + 184,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Compare&gt; ::= &lt;Op Compare&gt; '&lt;' &lt;Op Add&gt;</c></para>
        /// </summary>
        RuleOpcompareLt = ToolScriptParserBase.RulesOffset + 185,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Compare&gt; ::= &lt;Op Compare&gt; '&gt;' &lt;Op Add&gt;</c></para>
        /// </summary>
        RuleOpcompareGt = ToolScriptParserBase.RulesOffset + 186,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Compare&gt; ::= &lt;Op Compare&gt; '&lt;=' &lt;Op Add&gt;</c></para>
        /// </summary>
        RuleOpcompareLteq = ToolScriptParserBase.RulesOffset + 187,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Compare&gt; ::= &lt;Op Compare&gt; '&gt;=' &lt;Op Add&gt;</c></para>
        /// </summary>
        RuleOpcompareGteq = ToolScriptParserBase.RulesOffset + 188,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Compare&gt; ::= &lt;Op Add&gt;</c></para>
        /// </summary>
        RuleOpcompare = ToolScriptParserBase.RulesOffset + 189,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Add&gt; ::= &lt;Op Add&gt; '+' &lt;Op Mult&gt;</c></para>
        /// </summary>
        RuleOpaddPlus = ToolScriptParserBase.RulesOffset + 190,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Add&gt; ::= &lt;Op Add&gt; '-' &lt;Op Mult&gt;</c></para>
        /// </summary>
        RuleOpaddMinus = ToolScriptParserBase.RulesOffset + 191,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Add&gt; ::= &lt;Op Mult&gt;</c></para>
        /// </summary>
        RuleOpadd = ToolScriptParserBase.RulesOffset + 192,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Mult&gt; ::= &lt;Op Mult&gt; '*' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpmultTimes = ToolScriptParserBase.RulesOffset + 193,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Mult&gt; ::= &lt;Op Mult&gt; '/' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpmultDiv = ToolScriptParserBase.RulesOffset + 194,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Mult&gt; ::= &lt;Op Mult&gt; '%' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpmultPercent = ToolScriptParserBase.RulesOffset + 195,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Mult&gt; ::= &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpmult = ToolScriptParserBase.RulesOffset + 196,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= not &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpunaryNot = ToolScriptParserBase.RulesOffset + 197,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= '!' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpunaryExclam = ToolScriptParserBase.RulesOffset + 198,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= '-' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpunaryMinus = ToolScriptParserBase.RulesOffset + 199,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= cast '(' &lt;Op Unary&gt; as &lt;QualifiedName&gt; ')'</c></para>
        /// </summary>
        RuleOpunaryCastLparanAsRparan = ToolScriptParserBase.RulesOffset + 200,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= '++' &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpunaryPlusplus = ToolScriptParserBase.RulesOffset + 201,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= -- &lt;Op Unary&gt;</c></para>
        /// </summary>
        RuleOpunaryMinusminus = ToolScriptParserBase.RulesOffset + 202,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt; '++'</c></para>
        /// </summary>
        RuleOpunaryPlusplus2 = ToolScriptParserBase.RulesOffset + 203,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt; --</c></para>
        /// </summary>
        RuleOpunaryMinusminus2 = ToolScriptParserBase.RulesOffset + 204,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt; is null</c></para>
        /// </summary>
        RuleOpunaryIsNull = ToolScriptParserBase.RulesOffset + 205,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt; not null</c></para>
        /// </summary>
        RuleOpunaryNotNull = ToolScriptParserBase.RulesOffset + 206,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt; is not null</c></para>
        /// </summary>
        RuleOpunaryIsNotNull = ToolScriptParserBase.RulesOffset + 207,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Unary&gt; ::= &lt;Op Pointer&gt;</c></para>
        /// </summary>
        RuleOpunary = ToolScriptParserBase.RulesOffset + 208,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Pointer&gt; ::= &lt;Op Pointer&gt; '.' &lt;Value&gt;</c></para>
        /// </summary>
        RuleOppointerDot = ToolScriptParserBase.RulesOffset + 209,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Pointer&gt; ::= &lt;Op Pointer&gt; '-&gt;' &lt;Value&gt;</c></para>
        /// </summary>
        RuleOppointerMinusgt = ToolScriptParserBase.RulesOffset + 210,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Pointer&gt; ::= &lt;Op Pointer&gt; '[' &lt;Expr&gt; ']'</c></para>
        /// </summary>
        RuleOppointerLbracketRbracket = ToolScriptParserBase.RulesOffset + 211,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Pointer&gt; ::= &lt;Op Pointer&gt; '(' &lt;Args&gt; ')'</c></para>
        /// </summary>
        RuleOppointerLparanRparan = ToolScriptParserBase.RulesOffset + 212,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Op Pointer&gt; ::= &lt;Value&gt;</c></para>
        /// </summary>
        RuleOppointer = ToolScriptParserBase.RulesOffset + 213,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= IntLiteral</c></para>
        /// </summary>
        RuleValueIntliteral = ToolScriptParserBase.RulesOffset + 214,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= StringLiteral</c></para>
        /// </summary>
        RuleValueStringliteral = ToolScriptParserBase.RulesOffset + 215,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= DecimalLiteral</c></para>
        /// </summary>
        RuleValueDecimalliteral = ToolScriptParserBase.RulesOffset + 216,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= DateTimeLiteral</c></para>
        /// </summary>
        RuleValueDatetimeliteral = ToolScriptParserBase.RulesOffset + 217,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= TimeSpanLiteral</c></para>
        /// </summary>
        RuleValueTimespanliteral = ToolScriptParserBase.RulesOffset + 218,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= type '(' &lt;QualifiedName&gt; ')'</c></para>
        /// </summary>
        RuleValueTypeLparanRparan = ToolScriptParserBase.RulesOffset + 219,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= new &lt;QualifiedName&gt; '(' &lt;Args&gt; ')'</c></para>
        /// </summary>
        RuleValueNewLparanRparan = ToolScriptParserBase.RulesOffset + 220,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= ID</c></para>
        /// </summary>
        RuleValueId = ToolScriptParserBase.RulesOffset + 221,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= var ID</c></para>
        /// </summary>
        RuleValueVarId = ToolScriptParserBase.RulesOffset + 222,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= static ID</c></para>
        /// </summary>
        RuleValueStaticId = ToolScriptParserBase.RulesOffset + 223,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= '(' &lt;Expr&gt; ')'</c></para>
        /// </summary>
        RuleValueLparanRparan = ToolScriptParserBase.RulesOffset + 224,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= '[' &lt;Expr List&gt; ']'</c></para>
        /// </summary>
        RuleValueLbracketRbracket = ToolScriptParserBase.RulesOffset + 225,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= '{' &lt;Dict List&gt; '}'</c></para>
        /// </summary>
        RuleValueLbraceRbrace = ToolScriptParserBase.RulesOffset + 226,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= range '&lt;' &lt;Op Add&gt; ';' &lt;Op Add&gt; '&gt;'</c></para>
        /// </summary>
        RuleValueRangeLtSemiGt = ToolScriptParserBase.RulesOffset + 227,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= range '&lt;' &lt;Op Add&gt; ';' &lt;Op Add&gt; ')'</c></para>
        /// </summary>
        RuleValueRangeLtSemiRparan = ToolScriptParserBase.RulesOffset + 228,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= range '(' &lt;Op Add&gt; ';' &lt;Op Add&gt; '&gt;'</c></para>
        /// </summary>
        RuleValueRangeLparanSemiGt = ToolScriptParserBase.RulesOffset + 229,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= range '(' &lt;Op Add&gt; ';' &lt;Op Add&gt; ')'</c></para>
        /// </summary>
        RuleValueRangeLparanSemiRparan = ToolScriptParserBase.RulesOffset + 230,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= property &lt;Expr&gt; ';'</c></para>
        /// </summary>
        RuleValuePropertySemi = ToolScriptParserBase.RulesOffset + 231,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= property &lt;Expr&gt; get &lt;Expr&gt; ';'</c></para>
        /// </summary>
        RuleValuePropertyGetSemi = ToolScriptParserBase.RulesOffset + 232,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= property &lt;Expr&gt; get &lt;Expr&gt; set &lt;Expr&gt; ';'</c></para>
        /// </summary>
        RuleValuePropertyGetSetSemi = ToolScriptParserBase.RulesOffset + 233,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= &lt;Function&gt;</c></para>
        /// </summary>
        RuleValue = ToolScriptParserBase.RulesOffset + 234,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= dict</c></para>
        /// </summary>
        RuleValueDict = ToolScriptParserBase.RulesOffset + 235,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= list</c></para>
        /// </summary>
        RuleValueList = ToolScriptParserBase.RulesOffset + 236,

        /// <summary>
        /// <para>Pravidlo: </para>
        /// <para><c>&lt;Value&gt; ::= null</c></para>
        /// </summary>
        RuleValueNull = ToolScriptParserBase.RulesOffset + 237,
    ...
    public abstract class ToolScriptParserBase
    {
		...
		/// <para><c>align</c></para>
		/// </summary>
		protected virtual object TerminalAlign(TerminalToken token)
		{
			throw new NotImplementedException("Symbol align");
		}
		...
		/// <para><c>hpaned</c></para>
		/// </summary>
		protected virtual object TerminalHpaned(TerminalToken token)
		{
			throw new NotImplementedException("Symbol hpaned");
		}
		...
		/// <para><c>liststore</c></para>
		/// </summary>
		protected virtual object TerminalListstore(TerminalToken token)
		{
			throw new NotImplementedException("Symbol liststore");
		}
		...
		/// <para><c>scrolled</c></para>
		/// </summary>
		protected virtual object TerminalScrolled(TerminalToken token)
		{
			throw new NotImplementedException("Symbol scrolled");
		}
		...
		/// <para><c>treestore</c></para>
		/// </summary>
		protected virtual object TerminalTreestore(TerminalToken token)
		{
			throw new NotImplementedException("Symbol treestore");
		}
		...
		/// <para><c>vpaned</c></para>
		/// </summary>
		protected virtual object TerminalVpaned(TerminalToken token)
		{
			throw new NotImplementedException("Symbol vpaned");
		}
		...
		/// <para><c>&lt;Column List&gt;</c></para>
		/// </summary>
		protected virtual object TerminalColumnlist(TerminalToken token)
		{
			throw new NotImplementedException("Symbol Column List");
		}
		...
		/// <para><c>&lt;Column Name&gt;</c></para>
		/// </summary>
		protected virtual object TerminalColumnname(TerminalToken token)
		{
			throw new NotImplementedException("Symbol Column Name");
		}
		...
		/// <para><c>&lt;Store Item&gt;</c></para>
		/// </summary>
		protected virtual object TerminalStoreitem(TerminalToken token)
		{
			throw new NotImplementedException("Symbol Store Item");
		}
		...
		/// <para><c>&lt;TreeView Column&gt;</c></para>
		/// </summary>
		protected virtual object TerminalTreeviewcolumn(TerminalToken token)
		{
			throw new NotImplementedException("Symbol TreeView Column");
		}
        ...
        protected abstract object RuleColumnnameId(NonterminalToken token); // <Column Name> ::= ID
        protected abstract object RuleColumnnameStringliteral(NonterminalToken token); // <Column Name> ::= StringLiteral
        protected abstract object RuleColumnlistComma(NonterminalToken token); // <Column List> ::= <Column List> ',' <Column Name>
        protected abstract object RuleColumnlist(NonterminalToken token); // <Column List> ::= <Column Name>
        protected abstract object RuleColumnlist2(NonterminalToken token); // <Column List> ::= 
        ...
        protected abstract object RuleDbcolumnSemi(NonterminalToken token); // <DB Column> ::= <Column Name> <DB Column Type> <DB Column Attr List> ';'
        ...
        protected abstract object RuleDbtableattrIndexLparanRparanSemi(NonterminalToken token); // <DB Table Attr> ::= index '(' <Column List> ')' ';'
        protected abstract object RuleDbtableattrUniqueLparanRparanSemi(NonterminalToken token); // <DB Table Attr> ::= unique '(' <Column List> ')' ';'
        ...
        protected abstract object RuleLayoutblockHpanedEnd(NonterminalToken token); // <Layout Block> ::= hpaned <WndParam List> <Layout List> end
        protected abstract object RuleLayoutblockVpanedEnd(NonterminalToken token); // <Layout Block> ::= vpaned <WndParam List> <Layout List> end
        ...
        protected abstract object RuleLayoutblockScrolled(NonterminalToken token); // <Layout Block> ::= scrolled <WndParam List> <Layout Block>
        protected abstract object RuleLayoutblockAlign(NonterminalToken token); // <Layout Block> ::= align <WndParam List> <Layout Block>
        protected abstract object RuleLayoutblockImage(NonterminalToken token); // <Layout Block> ::= image <WndParam List>
        protected abstract object RuleLayoutblockTreeviewEnd(NonterminalToken token); // <Layout Block> ::= treeview <WndParam List> <TreeView Columns> end
        ...
        protected abstract object RuleMenuitemslist(NonterminalToken token); // <MenuItems List> ::= <MenuItems List> <Menu Item>
        ...
        protected abstract object RuleExprListstoreEnd(NonterminalToken token); // <Expr> ::= liststore <WndParam List> <Store Items> end
        protected abstract object RuleExprTreestoreEnd(NonterminalToken token); // <Expr> ::= treestore <WndParam List> <Store Items> end
        ...
        public virtual object CreateObjectFromNonterminal(NonterminalToken token)
        {
            switch (token.Rule.Id + ToolScriptParserBase.RulesOffset)
            {
                ...
                case (int)Symbols.RuleColumnnameId: //<Column Name> ::= ID
                	return RuleColumnnameId(token);
                case (int)Symbols.RuleColumnnameStringliteral: //<Column Name> ::= StringLiteral
                	return RuleColumnnameStringliteral(token);
                case (int)Symbols.RuleColumnlistComma: //<Column List> ::= <Column List> ',' <Column Name>
                	return RuleColumnlistComma(token);
                case (int)Symbols.RuleColumnlist: //<Column List> ::= <Column Name>
                	return RuleColumnlist(token);
                case (int)Symbols.RuleColumnlist2: //<Column List> ::= 
                	return RuleColumnlist2(token);
                ...
                case (int)Symbols.RuleDbcolumnSemi: //<DB Column> ::= <Column Name> <DB Column Type> <DB Column Attr List> ';'
                	return RuleDbcolumnSemi(token);
                ...
                case (int)Symbols.RuleDbtableattrIndexLparanRparanSemi: //<DB Table Attr> ::= index '(' <Column List> ')' ';'
                	return RuleDbtableattrIndexLparanRparanSemi(token);
                case (int)Symbols.RuleDbtableattrUniqueLparanRparanSemi: //<DB Table Attr> ::= unique '(' <Column List> ')' ';'
                ...
                case (int)Symbols.RuleLayoutblockHpanedEnd: //<Layout Block> ::= hpaned <WndParam List> <Layout List> end
                	return RuleLayoutblockHpanedEnd(token);
                case (int)Symbols.RuleLayoutblockVpanedEnd: //<Layout Block> ::= vpaned <WndParam List> <Layout List> end
                	return RuleLayoutblockVpanedEnd(token);
                ...
                case (int)Symbols.RuleLayoutblockScrolled: //<Layout Block> ::= scrolled <WndParam List> <Layout Block>
                	return RuleLayoutblockScrolled(token);
                case (int)Symbols.RuleLayoutblockAlign: //<Layout Block> ::= align <WndParam List> <Layout Block>
                	return RuleLayoutblockAlign(token);
                case (int)Symbols.RuleLayoutblockImage: //<Layout Block> ::= image <WndParam List>
                	return RuleLayoutblockImage(token);
                case (int)Symbols.RuleLayoutblockTreeviewEnd: //<Layout Block> ::= treeview <WndParam List> <TreeView Columns> end
                	return RuleLayoutblockTreeviewEnd(token);
                ...
                case (int)Symbols.RuleMenuitemslist: //<MenuItems List> ::= <MenuItems List> <Menu Item>
                ...
                case (int)Symbols.RuleTreeviewcolumns: //<TreeView Columns> ::= <TreeView Columns> <TreeView Column>
                ...
                case (int)Symbols.RuleExprListstoreEnd: //<Expr> ::= liststore <WndParam List> <Store Items> end
                	return RuleExprListstoreEnd(token);
                case (int)Symbols.RuleExprTreestoreEnd: //<Expr> ::= treestore <WndParam List> <Store Items> end
                	return RuleExprTreestoreEnd(token);
		...
		{
			throw new NotImplementedException("<Column Name> ::= ID");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Column Name> ::= StringLiteral");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Column List> ::= <Column List> ',' <Column Name>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Column List> ::= <Column Name>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Column List> ::= ");
			//return new
		}
		...
		{
			throw new NotImplementedException("<DB Column> ::= <Column Name> <DB Column Type> <DB Column Attr List> ';'");
			//return new
		}
		...
		{
			throw new NotImplementedException("<DB Table Attr> ::= index '(' <Column List> ')' ';'");
			//return new
		}

		// <DB Table Attr> ::= unique '(' <Column List> ')' ';'
		protected override object RuleDbtableattrUniqueLparanRparanSemi(NonterminalToken token)
		{
			throw new NotImplementedException("<DB Table Attr> ::= unique '(' <Column List> ')' ';'");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Layout Block> ::= hpaned <WndParam List> <Layout List> end");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Layout Block> ::= vpaned <WndParam List> <Layout List> end");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Layout Block> ::= scrolled <WndParam List> <Layout Block>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Layout Block> ::= align <WndParam List> <Layout Block>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<MenuItems List> ::= <MenuItems List> <Menu Item>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<TreeView Columns> ::= <TreeView Columns> <TreeView Column>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<TreeView Columns> ::= ");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Store Items> ::= <Store Items> <Store Item>");
			//return new
		}
		...
		{
			throw new NotImplementedException("<Store Items> ::= ");
			//return new
		}
		...
		*/
		...
		/*
			...
			Test(@"<Stm List> ::= <Stm>");
			Test(@"<Column Name> ::= ID");
			Test(@"<Column Name> ::= StringLiteral");
			Test(@"<Column List> ::= <Column List> ',' <Column Name>");
			Test(@"<Column List> ::= <Column Name>");
			Test(@"<Column List> ::= ");
			...
			Test(@"<DB Columns> ::= ");
			Test(@"<DB Column> ::= <Column Name> <DB Column Type> <DB Column Attr List> ';'");
			...
			Test(@"<DB Table Attr> ::= index '(' <Column List> ')' ';'");
			Test(@"<DB Table Attr> ::= unique '(' <Column List> ')' ';'");
			...
			Test(@"<Layout Block> ::= hpaned <WndParam List> <Layout List> end");
			Test(@"<Layout Block> ::= vpaned <WndParam List> <Layout List> end");
			...
			Test(@"<Layout Block> ::= scrolled <WndParam List> <Layout Block>");
			Test(@"<Layout Block> ::= align <WndParam List> <Layout Block>");
			Test(@"<Layout Block> ::= image <WndParam List>");
			Test(@"<Layout Block> ::= treeview <WndParam List> <TreeView Columns> end");
			...
			Test(@"<MenuItems List> ::= <MenuItems List> <Menu Item>");
			Test(@"<MenuItems List> ::= ");
			...
			Test(@"<Expr> ::= <Widget>");
			Test(@"<Expr> ::= <Database>");
			Test(@"<Expr> ::= liststore <WndParam List> <Store Items> end");
			Test(@"<Expr> ::= treestore <WndParam List> <Store Items> end");
			Test(@"<Expr> ::= <Op Assign>");
